...
#
# from src.scanner.common import extract_configurations_file, GITHUB_USER_CONFIGURATION_PATH, \
#     GITHUB_REPOSITORY_CONFIGURATION_PATH, ServiceType
# from src.github_client import GitHubClient
# from src.remediation.remediation import BaseRemediation
#
#
...
#     parser.add_argument("--service-type", required=True, choices=[s.value for s in ServiceType],
#                         help="Service type to load results from.")
...
#
#     scanner_results = BaseRemediation.load_scanner_results(service_type=args.service_type,
#                                                            scanner_results_path=args.scanner_results_path)
